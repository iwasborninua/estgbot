...
return [
    ...
    |
    |       - token:    Your TelegramService Bot's Access Token.
    ...
    */
    ...
    | Should be an instance of \TelegramService\Bot\HttpClients\HttpClientInterface
    |
    | Default: GuzzlePHP
    |
    */
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Register TelegramService Global Commands [Optional]
    |--------------------------------------------------------------------------
    |
    ...
    |
    | The command class should extend the \TelegramService\Bot\Commands\Command class.
    |
